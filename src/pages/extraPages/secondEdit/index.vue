<template>
  <div class="allbg">
    ...
    <van-popup
      ...
      @close="onClose"
    >
      <Factory @submit="factorysubmit"  :factoryId='formData.toFactoryId' @cancel="onClose"></Factory>
    </van-popup>
...
export default {
  ...
  methods: {
    ...
    getData2() {
      ...
      data["second"].getData(params).then((res) => {
        this.formData = {
          toFactoryName: res.data.data.toFactoryName,
          dispatchUserName:res.data.data.dispatchUserName,
          dispatchReason: res.data.data.dispatchReason,
          dailySalary: res.data.data.dailySalary,
          startDate: res.data.data.startDate.slice(0,10),
          endDate:res.data.data.endDate.slice(0,10),
          remark:res.data.data.remark,
          settlementMoney:res.data.data.settlementMoney,
          dispatchUserId:res.data.data.dispatchUserId,
          toFactoryId:res.data.data.toFactoryId
        };
        this.isEdit =
